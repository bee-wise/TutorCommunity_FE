  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      <Link
        ...
        className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-[#280F91] mb-6 transition-colors"
      >
      ...
      <div className="bg-white rounded-2xl border shadow-sm p-6 md:p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50/50 p-6 rounded-xl border border-gray-100 mb-8">
          <div>
            <p className="text-sm text-gray-500 mb-1">Học sinh</p>
            <p className="font-semibold text-gray-900">{lesson.studentName}</p>
          </div>
          <div>
            <p className="text-sm text-gray-500 mb-1">Môn học & Chủ đề</p>
          ...
          <div>
            <p className="text-sm text-gray-500 mb-1">Nguồn dữ liệu</p>
        ...
        <div className="mb-8">
          ...
          <textarea
            ...
            className="w-full p-4 text-sm text-gray-800 bg-gray-50 border rounded-lg focus:ring-2 focus:ring-[#280F91]/20 focus:border-[#280F91] outline-none transition-all"
            placeholder="Nội dung bóc băng từ Zoom sẽ hiển thị ở đây..."
          />
        </div>

        <div className="flex flex-col sm:flex-row gap-4 items-center justify-end border-t pt-6">
