...
const TRUST_ITEMS = [
  { id: "schedule", icon: CalendarCheckIcon, label: "Theo dõi lịch học rõ ràng" },
  { id: "history", icon: ChatCircleTextIcon, label: "Quản lý lịch sử trao đổi" },
  { id: "reconcile", icon: ArrowsCounterClockwiseIcon, label: "Đối soát thông tin minh bạch" },
          ...
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-4">
              ...
              >
                ...
                <span className="text-secondary">cùng BeeWise</span>
              </h2>
              <p className="text-foreground/60 leading-relaxed max-w-[48ch]">
                BeeWise xây dựng quy trình quản lý minh bạch để bảo vệ quyền
                lợi của cả gia sư và học viên.
              </p>
            </div>
